            ...
            public string user_name {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'user_name\' в таблице \'Login\' равно DBNull.", e);
                    }
                }
                set {
...
namespace Progas.loginDataSet3TableAdapters {
    ...
    public partial class LoginTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Login` WHERE ((`ID` = ?) AND ((? = 1 AND `user_name` IS NULL) OR (`u" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Login` (`user_name`, `password`) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Login` SET `user_name` = ?, `password` = ? WHERE ((`ID` = ?) AND ((? = 1 " +
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Progas.Properties.Settings.Default.loginConnectionString2;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, user_name, [password] FROM Login";
        ...
        public virtual int Fill(loginDataSet3.LoginDataTable dataTable) {
        ...
        public virtual loginDataSet3.LoginDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            loginDataSet3.LoginDataTable dataTable = new loginDataSet3.LoginDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(loginDataSet3.LoginDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(loginDataSet3 dataSet) {

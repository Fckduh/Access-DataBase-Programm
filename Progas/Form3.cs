...
namespace Login
{
    ...
    public partial class Form3 : Form
    {
        ...
        Regex er = new Regex(@"[^a-zA-ZА-Яа-я]+", RegexOptions.IgnoreCase);
        Regex rx = new Regex(@"\D", RegexOptions.IgnoreCase);
        Regex ex = new Regex(@"[^0-2]+", RegexOptions.IgnoreCase);
        ...
        {
            textBox5.Text = ex.Replace(textBox5.Text, "");
        }

        private void textBox2_TextChanged(object sender, EventArgs e)
        {
            textBox2.Text = er.Replace(textBox2.Text, "");
        }
    }
}
